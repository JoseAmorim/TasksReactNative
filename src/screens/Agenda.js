...
export default class Agenda extends Component {
    ...
    render() {
        ...
        switch(this.props.daysAhead) {
            case 0:
                styleColor = common.colors.today;
                image = todayImage;
                break;
            case 1:
                styleColor = common.colors.tomorrow;
                image = tomorrowImage;
                break;
            case 7:
                styleColor = common.colors.week;
                image = weekImage;
                break;
            default:
                styleColor = common.colors.month;
                image = monthImage;
                break;
        };
                    ...
                    <View style={styles.iconBar}>
                        ...
                        <TouchableOpacity onPress={this.toggleFilter}>
                            <Icon name={this.state.showDoneTasks ? 'eye' : 'eye-slash'}
                                size={20} color={common.colors.secondary} />
                        </TouchableOpacity>
                    </View>
